                        ...
                        <article class="blog-post blog-post-item">
                            <div class="blog-post__row">
                                <div class="blog-post__content">
                                    <h2><a href="blog-post-single.html">{{ $post->title }}</a></h2>
                                    <figure class="blog-post__thumb text-center"><a href="blog-post-single.html"><img class="img-responsive" src="{{ asset($post->path ?? $post->thumb_path) }}" alt="{{ $post->title }}"></a></figure>
