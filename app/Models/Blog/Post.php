...
class Post extends Model
{
    ...
    use Sluggable;
    const TYPE = [1 => 'BLOG', 'TREATMENT', 'EXAM'];
    ...
    {
        return $query->where('category_id', '=', array_search('TREATMENT', self::TYPE));
    }
    public function scopeExam($query)
    {
        return $query->where('category_id', '=', array_search('EXAM', self::TYPE));
    }
